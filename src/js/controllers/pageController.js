...
const refreshPageForRole = async () => {
  ...
  if (roleBadge) {
    roleBadge.textContent = currentUserRole === 0 ? "Not registered" : ROLE_NAMES[currentUserRole];
    roleBadge.classList.remove("hidden");
  }

  if (typeof applyRoleLayout === "function") applyRoleLayout(currentUserRole);
  if (typeof updateRegistrationView === "function") updateRegistrationView(currentUserRole);
  ...
  if (document.body.dataset.page === "profile" && typeof loadProfilePage === "function") {
